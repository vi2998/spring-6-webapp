...
public class BootstrapData implements CommandLineRunner {
    /* Quando usare CommandLineRunner?

    ✅ Per inizializzare dati nel database all'avvio.
    ✅ Per logiche di bootstrap (es. creare utenti di default).
    ✅ Per eseguire script o test all'avvio.
